...
void kickstart(void) {
    uint8_t binmap[1000][6] = {
        ...
        {0xA0, 0x10, 0x11, 0x47, 0x00, 0x00}, //5F
        
        {0x01, 0x22, 0x41, 0x00, 0x00, 0x00}, //60
        
        {0x08, 0x41, 0x10, 0x20, 0x63, 0x00}, //61
        {0x02, 0x22, 0x42, 0x00, 0x00, 0x00}, //62
        {0x08, 0x44, 0x22, 0x42, 0x67, 0x00}, //63
        {0xA0, 0x20, 0x21, 0x41, 0x00, 0x00}, //64
        {0x01, 0x20, 0x10, 0x00, 0x00, 0x00}, //65
        {0x01, 0x21, 0x11, 0x00, 0x00, 0x00}, //66
        
        {0x08, 0x41, 0x11, 0x21, 0x69, 0x00}, //67
        {0x02, 0x22, 0x42, 0x00, 0x00, 0x00}, //68
        {0x08, 0x44, 0x22, 0x42, 0x6D, 0x00}, //69
        {0xA0, 0x20, 0x21, 0x41, 0x00, 0x00}, //6A
        {0x01, 0x20, 0x10, 0x00, 0x00, 0x00}, //6B
        {0x01, 0x21, 0x11, 0x00, 0x00, 0x00}, //6C
        
        {0x07, 0x5E, 0x00, 0x00, 0x00, 0x00}, //6D
    };
